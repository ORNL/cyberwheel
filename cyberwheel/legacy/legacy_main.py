...
def debug_env(env):
    ...
    env = DecoyAgentCyberwheel(
        network_config="/home/70d/RL_For_Cyber/cyberwheel/cyberwheel/network/network_generation/network-cac9fa081e8a4edd856345da364c79b3.yaml"
    )
    check_env(env)
...
def main():
    ...
    vec_env = SubprocVecEnv(
        [make_env("cyberwheel", i) for i in range(num_cpus)]
    )  # Create a vectorized environment with multiple instances of the Cyberwheel environment
