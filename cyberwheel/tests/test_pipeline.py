...
class TestPipeline(unittest.TestCase):
    ...
    def test_pipeline_with_technique(self):
        ...
        target_service = Service("8080", "3.4.25", "IPFilter", vulnerabilities=['CVE-2002-0515']) # Port is made up, but the vulnerability is real
        ...
        red_action = PortScan(self.src_host, target_service, self.target_hosts, [technique])
